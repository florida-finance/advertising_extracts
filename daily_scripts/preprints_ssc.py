...
A = pd.DataFrame(columns=["Entity","SubEntity","Scenario","Version","Years", "Period", "Department", "Product","Retail Local Preprints (400300)","General Loca l Preprints (402300)","Retail T365 Preprints (400350)","General T365 Preprints"], data=rows)
